...
const TransactionTable = ({from,to}:Props) => {
      const [sorting,setSorting]=useState<SortingState>([])
       ...
       return (
        <div className="w-full flex flex-col flex-wrap container gap-4 p-6">
        <SkeletonWrapper isLoading={history.isFetching} fullWidth>
...
function RowActions({transaction}:{transaction:TransactionHistoryRow}){
    ...
    return (
      <>
      <DeleteTransactionDialog open={showDeleteDialog} setOpen={setShowDeleteDialog} transaction={transaction}/>
      <DropdownMenu>
