...
const History = ({userSettings}:{userSettings:UserSettings}) => {
  ...
  return (
    <div className='container gap-2 p-6 flex flex-wrap overflow-hidden max-w-[80%]' >
        <h2 className="mt-12 text-3xl font-bold"> 
            History
        </h2>
        <Card className='span-12 mt-2 w-full'>
            <CardHeader className='gap-2'>
                <CardTitle className='grid grid-flow-row justify-between gap-2 md:grid-flow-col'>
                  <HistoryPeriodSelector period={period} 
                  setPeriod={setPeriod} timeFrame={timeFrame}
            ...
            <CardContent>
              <SkeletonWrapper isLoading={historyDataQuery.isFetching} fullWidth={false}>
                  ...
                  {
                    !dataAvailable && (
                      <Card className="flex h-[300px] flex-col items-center
