    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle>
                        Create <span className={cn("m-1", type == 'income' ? "text-emerald-500" : "text-red-500")}>
                            {type}
                        </span>
                        category
                    </DialogTitle>
                    <DialogDescription>
                        Categories are used to group your transacrion
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                        ...
                                        <PopoverTrigger asChild>
                                            ...
                                            className='h-[100px] w-full'>
                                               {form.watch("icon")?(
                                                    ...
                                                    <span className='text-5xl h-[48px] w-[48px]' role="img">{field.value}</span>
                                    ...
                                    <FormDescription>
                                       This is how your category will appear in application
                                    </FormDescription>
                                </FormItem>
                            )}
                        />
